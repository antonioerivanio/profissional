CREATE TABLE SRH.ESOCIAL_FECHAMENTOFOLHA(
    ...
    CONSTRAINT "PK_ESOCIAL_FECHAMENTOFOLHA" PRIMARY KEY(ID),
    CONSTRAINT  "UN_ESOCIAL_FECHAMENTOFOLHA" UNIQUE(REFERENCIA),
	 CONSTRAINT "FK_FECHAMENTOFOLHA_FUNCIONAL" FOREIGN KEY ("IDFUNCIONAL")
