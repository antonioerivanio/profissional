CREATE TABLE SRH.ESOCIAL_FECHAMENTOEVENTO(
    "ID" NUMBER(10) CONSTRAINT NN_ESOCIAL_FECHAMENT NOT NULL,
    "IDFUNCIONAL" NUMBER(9,0) NOT NULL ENABLE, 
	"REFERENCIA" VARCHAR2(30 BYTE), 
    "TP_INSC" NUMBER(1),
    "NR_INSC" VARCHAR2(14),
    "EVT_REMUN" NUMBER(1) DEFAULT 1,
    "EVT_COMPROD" NUMBER(1) DEFAULT 0,
    "EVT_CONTRAAVNP" NUMBER(1) DEFAULT 0,
    "EVT_INFOCOMPLPER" NUMBER(1) DEFAULT 0,
    "TRANS_DCTWEB" NUMBER(1) ,
    "NAO_VALID" NUMBER(1) ,
    
    CONSTRAINT "PK_ESOCIAL_FECHAMENTOEVENTO" PRIMARY KEY(ID),
    CONSTRAINT  "UN_ESOCIAL_FECHAMENTOEVENTO" UNIQUE(REFERENCIA),
	 CONSTRAINT "FK_FECHAMENTOEVENTO_FUNCIONAL" FOREIGN KEY ("IDFUNCIONAL")
	  REFERENCES "SRH"."ESOCIAL_FECHAMENTOEVENTO" ("ID") ENABLE
);
