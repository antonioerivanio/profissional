  CREATE TABLE "SRH"."ESOCIAL_FECHAMENTOFOLHA" 
   (	"ID" NUMBER(10,0) CONSTRAINT "NN_ESOCIAL_FECHAMENT" NOT NULL ENABLE, 
	"REFERENCIA" VARCHAR2(30 BYTE), 
	"TP_INSC" NUMBER(1,0), 
	"NR_INSC" VARCHAR2(14 BYTE), 
	"EVT_REMUN" CHAR(1) DEFAULT 'S', 
	"EVT_COMPROD" CHAR(1) DEFAULT 'N', 
	"EVT_CONTRAAVNP" CHAR(1) DEFAULT 'N', 
	"EVT_INFOCOMPLPER" CHAR(1) DEFAULT 'N', 
	"TRANS_DCTWEB" CHAR(1), 
	"NAO_VALID" CHAR(1), 
    ...
    GRANT REFERENCES,SELECT ON SRH.ESOCIAL_FECHAMENTOFOLHA TO CONECTOR_ESOCIAL;
