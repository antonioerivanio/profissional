  CREATE TABLE "SRH"."ESOCIAL_FECHAMENTOFOLHA" 
   (	"ID" NUMBER(10,0) CONSTRAINT "NN_ESOCIAL_FECHAMENT" NOT NULL ENABLE, 
	...
	"EVT_REMUN" NUMBER(1,0) DEFAULT 1, 
	"EVT_COMPROD" NUMBER(1,0) DEFAULT 0, 
	"EVT_CONTRAAVNP" NUMBER(1,0) DEFAULT 0, 
	"EVT_INFOCOMPLPER" NUMBER(1,0) DEFAULT 0, 
	"TRANS_DCTWEB" NUMBER(1,0), 
	"NAO_VALID" NUMBER(1,0), 
