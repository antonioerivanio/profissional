create table "SRH"."ESOCIAL_HASH_ALTERACAOCAD"(
    "ID" NUMBER(10) CONSTRAINT NN_ESOCIAL_HASH_ALTERACAOCAD NOT NULL,
    "IDFUNCIONAL" NUMBER(10),
    "CODIGOHASH" VARCHAR2(500),
    "ORIGEM" VARCHAR2(10),
    
    CONSTRAINT "PL_ESOCIAL_HASH_ALTERACAOCAD" PRIMARY KEY("ID"),
    CONSTRAINT "FK_ESOCIALHASHALTERCAD_FUNC" FOREIGN KEY ("IDFUNCIONAL")
	  REFERENCES "SRH"."TB_FUNCIONAL" ("ID") ENABLE
)

create table "SRH"."ESOCIAL_HASH_ALTERACAOCONTRAT"(
    "ID" NUMBER(10) CONSTRAINT NN_ESOCIAL_HASH_ALTCONTRATUAL NOT NULL,
    "IDFUNCIONAL" NUMBER(10),
    "CODIGOHASH" VARCHAR2(500),
    "ORIGEM" VARCHAR2(10),
    
    CONSTRAINT "PL_ESOCIAL_HASH_ALTERCONTRAT" PRIMARY KEY("ID"),
    CONSTRAINT "FK_ESOCIALHASHALTERCONT_FUNC" FOREIGN KEY ("IDFUNCIONAL")
	  REFERENCES "SRH"."TB_FUNCIONAL" ("ID") ENABLE
)

CREATE TABLE "SRH"."ESOCIAL_ALTERACAOCADASTRAL" 
   (	"ID" NUMBER(9,0), 
	"REFERENCIA" VARCHAR2(150 BYTE) NOT NULL ENABLE,  
    "IDFUNCIONAL" NUMBER(9,0), 
    "TP_INSC" NUMBER(1,0), 
	"NR_INSC" VARCHAR2(15 BYTE), 
	"CPF_TRAB" VARCHAR2(11 BYTE),    
	"NM_TRAB" VARCHAR2(70 BYTE), 
	"SEXO" CHAR(1 BYTE), 
	"RACA_COR" NUMBER(1,0), 
	"EST_CIV" NUMBER(1,0), 
	"GRAU_INSTR" VARCHAR2(2 BYTE), 	
    "NM_SOCIAL" VARCHAR2(70 BYTE), 
	"PAIS_NAC" VARCHAR2(3 BYTE),     
	"TP_LOGRAD" VARCHAR2(4 BYTE), 
	"DSC_LOGRAD" VARCHAR2(100 BYTE), 
	"NR_LOGRAD" VARCHAR2(10 BYTE), 
	"COMPLEMENTO" VARCHAR2(30 BYTE), 
	"BAIRRO" VARCHAR2(90 BYTE), 
	"CEP" VARCHAR2(9 BYTE) NOT NULL ENABLE, 
	"COD_MUNIC_END" NUMBER(7,0), 
	"UF" VARCHAR2(2 BYTE),
	"DEF_FISICA" CHAR(1 BYTE), 
	"DEF_VISUAL" CHAR(1 BYTE), 
	"DEF_AUDITIVA" CHAR(1 BYTE), 
	"DEF_MENTAL" CHAR(1 BYTE), 
	"DEF_INTELECTUAL" CHAR(1 BYTE), 
	"DEF_REAB_READAP" CHAR(1 BYTE), 
	"DEF_INFO_COTA" CHAR(1 BYTE), 
	"DEF_OBESERVACAO" VARCHAR2(255 BYTE), 
    "FONE_PRINC" VARCHAR2(13 BYTE), 
	"EMAIL_PRINC" VARCHAR2(60 BYTE),
    
    CONSTRAINT "PK_ESOCIAL_ALTERACAOCADASTRAL" PRIMARY KEY ("ID"), 
    CONSTRAINT "FK_ESOCIAL_ALTERACAOCAD_FUNC" FOREIGN KEY ("IDFUNCIONAL")
	REFERENCES "SRH"."TB_FUNCIONAL" ("ID") ENABLE    
);

  GRANT REFERENCES ON "SRH"."ESOCIAL_ALTERACAOCADASTRAL" TO "CONECTOR_ESOCIAL";
  GRANT SELECT ON "SRH"."ESOCIAL_ALTERACAOCADASTRAL" TO "CONECTOR_ESOCIAL";
