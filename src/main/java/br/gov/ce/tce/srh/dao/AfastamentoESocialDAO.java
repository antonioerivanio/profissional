...
public class AfastamentoESocialDAO {
	...
	public StringBuilder getSQLEventoS2230() {
		...
		sql.append("TO_CHAR(tb_tipolicenca.codigoesocial,'09') AS COD_MOT_AFAST, ");
	    ...
	    sql.append("  AND (tb_licenca.fim > TO_DATE('21/11/2021', 'DD/MM/YYYY') and  tb_licenca.inicio <= sysdate) ");
		//sql.append("AND tb_licenca.fim > to_date('21/11/2021', 'dd/mm/yyyy') ");
