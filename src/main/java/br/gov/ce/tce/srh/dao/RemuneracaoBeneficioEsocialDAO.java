...
@Repository
public class RemuneracaoBeneficioEsocialDAO {

	static Logger logger = Logger.getLogger(RemuneracaoBeneficioEsocialDAO.class);
	...
	private Long getMaxId() {
		Query query = entityManager.createQuery("Select max(e.id) from RemuneracaoBeneficio e ");
		return query.getSingleResult() == null ? 1 : (Long) query.getSingleResult() + 1;
	}

	public RemuneracaoBeneficio salvar(RemuneracaoBeneficio entidade) {
	...
	public RemuneracaoBeneficio getById(Long id) {
		return entityManager.find(RemuneracaoBeneficio.class, id);
	}
	...
	public int count(String nome, String cpf, String periodoApuracao) {
		...
		sql.append(" Select count(rt) FROM RemuneracaoBeneficio rt  WHERE 1=1 ");
	...
	public List<RemuneracaoBeneficio> search(String nome, String cpf, String periodoApuracao, Integer first, Integer rows) {

		StringBuffer sql = new StringBuffer();

		sql.append("  SELECT rt FROM RemuneracaoBeneficio rt  WHERE 1=1 ");
	...
	@SuppressWarnings("unchecked")
	public RemuneracaoBeneficio getEventoS1207(String mesReferencia, String anoReferencia, String periodoApuracao, Funcional servidorFuncional) {
		try {
			Query query = entityManager.createNativeQuery(getSQLEventoS1207(servidorFuncional), RemuneracaoBeneficio.class);
			...
			return  (RemuneracaoBeneficio) query.getSingleResult();
	...
	public String getSQLEventoS1207(Funcional servidorFuncional) {
		StringBuffer sql = new StringBuffer();
