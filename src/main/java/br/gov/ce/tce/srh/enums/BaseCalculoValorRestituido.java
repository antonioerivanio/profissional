...
public enum BaseCalculoValorRestituido {
  VALOR_MAXIMO_PARA_PESSOA_IDADE_ATE_30ANOS("3%", 814.12),
  VALOR_MAXIMO_PARA_PESSOA_IDADE_31_ATE_40ANOS("3.5%",949.80),
  VALOR_MAXIMO_PARA_PESSOA_IDADE_41_ATE_50ANOS("4%", 1085.49),
  VALOR_MAXIMO_PARA_PESSOA_IDADE_51_ATE_60ANOS("4.5%", 1221.17),
  VALOR_MAXIMO_PARA_PESSOA_IDADE_SUPERIOR_60ANOS("5%" , 1356.86);
