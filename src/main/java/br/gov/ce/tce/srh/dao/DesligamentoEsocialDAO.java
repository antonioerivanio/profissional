...
public class DesligamentoEsocialDAO {
  ...
  public String getSQLEventoS2299() {
    ...
    sql.append("  1     AS tp_insc_locatacao, ");
    sql.append("  null  AS nr_insc_locatacao, ");
