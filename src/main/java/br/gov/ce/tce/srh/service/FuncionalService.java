...
public class FuncionalService {
	...
	public List<Funcional> findServidoresEvento2205() {		
		return dao.findServidoresEvento2205();
	}
	...
	public List<Funcional> findServidoresEvento2399() {        
      return dao.findServidoresEvento2399();
    }
	...
	public List<Funcional> findServidoresEventoAuxilioSaude() {
	   return dao.findServidoresEventoAuxilioSaude();
	}
	...
	public List<Funcional> findServidorEvento2300() {
		return dao.findServidorEvento2300();
	}
	...
	public List<Funcional> findServidorEvento1210(String anoReferencia, String mesReferencia) {
		return dao.findBeneficioesEvento1210(anoReferencia, mesReferencia);
	}
