...
@Scope("view")
public class RemuneracaoEstagiarioFormBean implements Serializable {

	static Logger logger = Logger.getLogger(RemuneracaoEstagiarioFormBean.class);
	...
	public void carregaServidores() {
		this.servidorEnvioList = funcionalService.findEstagiarioEvento1200(anoReferencia, mesReferencia);
	}
	public void consultar() {
		if(!mesReferencia.equalsIgnoreCase("0")  && !anoReferencia.equalsIgnoreCase("") && servidorFuncional != null) {
			try {
				boolean isEstagiario = true;
				entidade =  remuneracaoTrabalhadorEsocialService.getEventoS1200(mesReferencia, anoReferencia, servidorFuncional, isEstagiario);
