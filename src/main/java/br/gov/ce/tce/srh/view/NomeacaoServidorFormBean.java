...
public class NomeacaoServidorFormBean implements Serializable {
  ...
  public Funcional getEntidade() {
    return entidade;
  }

  public void setEntidade(Funcional entidade) {
  ...
  public Boolean getTpOcupacaoCargoComissionado() {
    return tpOcupacaoCargoComissionado;
  }

  public void setTpOcupacaoCargoComissionado(Boolean tpOcupacaoCargoComissionado) {
    this.tpOcupacaoCargoComissionado = tpOcupacaoCargoComissionado;
  }
  ...
  public void setLeiIncorporacao(LeiIncorporacao leiIncorporacao) {
  ...
  public Boolean getLiberarQtdQuintos() {
    return liberarQtdQuintos;
  }

  public Boolean getExibirPrevSuperSec() {
    return exibirPrevSuperSec;
  }

  public Boolean getExibirOrgaoEhSalario() {
    return exibirOrgaoEhSalario;
  }

  /*
   * public Boolean getDigitarMatricula() {return digitarMatricula;} public void
   * setDigitarMatricula(boolean digitarMatricula) {
   * 
   * if(!digitarMatricula){ entidade.setMatricula(""); } }
   */
  ...
  public Boolean getDigitarMatricula() {
    return digitarMatricula;
  }
