  ...
  public void consultar() {
    if (servidorFuncional != null) {
      try {
        ...
        /*
         * if(servidorFuncional != null) { int index = servidorEnvioList.indexOf(servidorFuncional);
         * servidorFuncional = servidorEnvioList.get(index); getEntidade().setFuncional(servidorFuncional);
         * }
         */
        
        if( getEntidade().getTipoInscricaoEmpregador() == null) {
          getEntidade().setTipoInscricaoEmpregador(TipoInscricao.CNPJ.getCodigo().toString());
        }
        
        if( getEntidade().getTipoInscricaoLotacao() == null) {
          getEntidade().setTipoInscricaoLotacao(TipoInscricao.CNPJ.getCodigo().toString());
        }
