...
public class SRHUtils {
  ...
  /**
   * Método responsável por adicionar ou remover número de dias de uma data Obs.: sinal negativo no
   * parâmetro qtdDias irá fazer com que seja removido o número de dias informado, caso contrário,
   * será adicionado a mesma, gerando uma nova data.
   * 
  ...
  /**
   * Método responsável por retornar a data a partir da qual não se deduz faltas do tempo de serviço
   * 
   * @return data inicio
   */
  ...
  /**
   * Método para comparar duas datas e retornar o número de dias de diferença entre elas. Leva em
   * consideração ano bissexto
   * 
   * @param dataLow
   * @param dataHigh
   * 
  ...
  /**
   * Método com cálculo específico para Averbação que compara duas datas e retorna o numero de dias de
  ...
  /**
   * Método que compara duas datas e retorna o número de anos, meses e dias entre elas. O cálculo
   * feito no método produz um resultado próximo ao demonstrativo da simulação do cálculo do tempo de
  ...
  /**
   * Formata uma data de acordo com o parâmetro passado Ex. parâmetro formato: dd/MM/yyyy, dd/MM/yyyy
   * HH:mm:ss, dd/MM
   * 
   * @param formato
   * @param data
  ...
  public static boolean isCNPJ(String CNPJ) {
    ...
    if (CNPJ.equals("00000000000000") || CNPJ.equals("11111111111111") || CNPJ.equals("22222222222222")
                              ...
                              || CNPJ.equals("99999999999999") || (CNPJ.length() != 14) || CNPJ.isEmpty()
                              || CNPJ == null)
      return (false);
  ...
  /**
   * Método que verifica se o Dígito Verificador de uma Agência Bradesco é válida, na qual esta deve
   * ser informada no seguinte padrão: NNNN-D, onde N é um valor numerico e D um valor numerico que
   * representa o dígito verificador gerado a partir dos outros 4 números informados antes do hífen
   * (-).
   * 
   * @param agencia
   * @return Boolean
  ...
  /**
   * Método que verifica se o Dígito Verificador de uma Conta Corrente Bradesco é válida, na qual esta
   * deve ser informada no seguinte padrão: NNNNNNN-D, onde N é um valor numerico e D um valor
   * numerico que representa o dígito verificador gerado a partir dos outros sete números informados
   * antes do hífen (-).
   * 
   * @param conta
   * @return Boolean
  ...
  // Codigo 0 - Formatar padrão SAP, caso contrário, Retira do padrao SAP e joga no Padrão exibido ao
  // usuário
