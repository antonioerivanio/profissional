...
@Table(name = "usuarios")
@NamedQueries({
		@NamedQuery(name = "Usuario.findByUsernome", query = "SELECT usu FROM Usuario usu WHERE UPPER(usu.nome) = UPPER(:nome)"),
...
public class Usuario implements UserDetails {
	...
	public String toString() {
		return "Usuario(id=" + getId() + ", email=" + getEmail() + ", password=" + getPassword() + ", nome=" + getNome()
				+ ", matricula=" + getMatricula() + ", cpf=" + getCpf() + ", enabled=" + isEnabled()
				+ ", isMembroComissao=" + isMembroComissao() + ", roles=" + getGrupoUsuario() + ")";
	}
