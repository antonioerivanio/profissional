...
import br.gov.ce.tce.srh.dao.TipoPublicacaoDAOImpl;
import br.gov.ce.tce.srh.domain.TipoPublicacao;

public class TipoPublicacaoDAOTest extends DatabaseTestCase {

	private static final String PERSISTENCE_UNIT_NAME = "maindatabase";
	private EntityManagerFactory emf;
	private EntityManager em;

	private TipoPublicacaoDAOImpl dao = new TipoPublicacaoDAOImpl();

	private static int countTests = 0;


	public TipoPublicacaoDAOTest() {
    ...
    /**
	 * Test of br.gov.ce.tce.srh.dao.TipoPublicacaoDAOImpl.findAll
	 */
    @Test
    public void testFindAll() throws Exception {
        ...
        List<TipoPublicacao> lista = dao.findAll();
