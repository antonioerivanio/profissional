...
public class TipoMovimentoTest extends DatabaseTestCase {
	...
	public void testChavePrimaria() throws SQLException, Exception {
		...
		ITable tableAlunoAtual = baseAtual.getTable("TB_TIPOMOVIMENTO");
	...
	public void testTipoColuna() throws SQLException, Exception {
		...
		String abreviatura = colunas[3].getSqlTypeName();
