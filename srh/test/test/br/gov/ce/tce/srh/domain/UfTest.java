...
public class UfTest extends DatabaseTestCase {
	...
	public void testChavePrimaria() throws SQLException, Exception {
		...
		ITable tableAlunoAtual = baseAtual.getTable("TB_UF");
		...
		Assert.assertTrue(pkAtual[0].getColumnName().equalsIgnoreCase("UF"));
