...
public class AcrescimoTest extends DatabaseTestCase {
	...
	public void testChavePrimaria() throws SQLException, Exception {
		...
		ITable tableAlunoAtual = baseAtual.getTable("TB_ACRESCIMO");
	...
	public void testTipoColuna() throws SQLException, Exception {
		...
		String DATA_INICIO = colunas[3].getSqlTypeName();
		String DATA_FIM = colunas[4].getSqlTypeName();
		String QTDEDIAS = colunas[5].getSqlTypeName();
