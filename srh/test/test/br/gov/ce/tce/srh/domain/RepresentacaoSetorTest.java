...
public class RepresentacaoSetorTest extends DatabaseTestCase {
	...
	public void testChavePrimaria() throws SQLException, Exception {
		...
		ITable tableAlunoAtual = baseAtual.getTable("TB_REPRESENTACAOSETOR");
	...
	public void testTipoColuna() throws SQLException, Exception {
		...
		String IDSETOR = colunas[1].getSqlTypeName();
		String IDREPRESENTACAOCARGO = colunas[2].getSqlTypeName();
		String QUANTIDADE = colunas[3].getSqlTypeName();
		String INICIO = colunas[4].getSqlTypeName();
		String FIM = colunas[5].getSqlTypeName();
		String ATIVO = colunas[6].getSqlTypeName();
		String OBSERVACAO = colunas[7].getSqlTypeName();
		String HIERARQUIA = colunas[8].getSqlTypeName();
		...
		Assert.assertEquals("NUMBER", HIERARQUIA);
