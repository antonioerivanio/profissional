...
public class EscolaridadeTest extends DatabaseTestCase {
	...
	public void testChavePrimaria() throws SQLException, Exception {
		...
		ITable tableAlunoAtual = baseAtual.getTable("TB_ESCOLARIDADE");
	...
	public void testQtdColuna() throws SQLException, Exception {
		IDataSet baseAtual = getConnection().createDataSet();
		ITable tableAlunoAtual = baseAtual.getTable("TB_ESCOLARIDADE");
	...
	public void testTipoColuna() throws SQLException, Exception {
		...
		String codigoRais = colunas[4].getSqlTypeName();
		...
		Assert.assertEquals("NUMBER", codigoRais);
