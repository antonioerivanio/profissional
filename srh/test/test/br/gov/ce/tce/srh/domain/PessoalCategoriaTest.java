...
public class PessoalCategoriaTest extends DatabaseTestCase {
	...
	public void testChavePrimaria() throws SQLException, Exception {
		...
		ITable tableAlunoAtual = baseAtual.getTable("TB_PESSOALCATEGORIA");
	...
	public void testGetAnSet() throws SQLException, Exception {
		...
		PessoalCategoria entidade = new PessoalCategoria();

		entidade.setId(1l);
		entidade.setNome("TESTE");

		Assert.assertEquals(entidade.getId(), new Long(1));
		Assert.assertEquals(entidade.getNome(), "TESTE");
