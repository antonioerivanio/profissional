...
public class CompetenciaCursoTest extends DatabaseTestCase {
	...
	public void testChavePrimaria() throws SQLException, Exception {
		...
		ITable tableAlunoAtual = baseAtual.getTable("TB_COMPETENCIACURSO");
	...
	public void testTipoColuna() throws SQLException, Exception {
		...
		String IDCOMPETENCIA = colunas[1].getSqlTypeName();
		String IDCURSOPROFISSIONAL = colunas[2].getSqlTypeName();
		String INICIOCOMPETENCIA = colunas[3].getSqlTypeName();
