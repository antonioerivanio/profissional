...
public class DeducaoListBean implements Serializable {
	...
	public String relatorio() {
		...
		try {
			...
			relatorioUtil.relatorio("deducao.jasper", parametros, "deducao.pdf");
	...
	public List<Deducao> getLista() {return lista;}
	public void setLista(List<Deducao> lista) {this.lista = lista;}
