...
@Table(name="TB_TIPOLICENCA", schema="SRH")
public class TipoLicenca extends BasicEntity<Long> implements Serializable {
	...
	public String getSexoValido() {return sexoValido;}
	public void setSexoValido(String sexoValido) {this.sexoValido = sexoValido;}

	public Long getQtdeMaximoDias() {return qtdeMaximoDias;}
	public void setQtdeMaximoDias(Long qtdeMaximoDias) {this.qtdeMaximoDias = qtdeMaximoDias;}
